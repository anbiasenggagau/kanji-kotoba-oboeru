<template>
    <ConfirmDialog unstyled :pt="theme" :ptOptions="{
        ...
        <template #container="{ message, acceptCallback, rejectCallback }">
            ...
            <div class="pt-0 px-5 pb-5 flex justify-end gap-2">
                <Button @click="rejectCallback" :label="message.rejectProps.label" size="small" />
                <SecondaryButton @click="acceptCallback" :label="message.acceptProps.label" size="small" />
            </div>
        </template>
    </ConfirmDialog>
</template>
